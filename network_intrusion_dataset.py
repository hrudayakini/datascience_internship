...
df_train=pd.read_csv(r'C:/Users/Pia Purohit/PycharmProjects/nsl-kdd/KDDTrain+.txt',header=None,names=columns)
df_test=pd.read_csv(r'C:/Users/Pia Purohit/PycharmProjects/nsl-kdd/KDDTest+.txt',header=None,names=columns)
